...
This repository was forked from hakimel/reveal.js in order to be used for my presentations (I'm adding just new content). I've adapted the visualization for my needs, but the core remains unchanged. I keep the original readme.md file.
